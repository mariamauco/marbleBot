...
def generate_pwm(lines, duty_cycle, frequency):
    # Calculate high and low times based on the duty cycle
    ...
    while True:
        # Set the pin high for the high time
        line1.set_value(1)
        time.sleep(high_time)
        
        # Set the pin low for the low time
        line1.set_value(0)
        time.sleep(low_time)
